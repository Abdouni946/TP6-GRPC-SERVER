...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest,
      Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest,
      Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest, Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest,
      Bank.ConvertCurrencyResponse> getPerformBidirectionalStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "performBidirectionalStream",
      requestType = Bank.ConvertCurrencyRequest.class,
      responseType = Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest,
      Bank.ConvertCurrencyResponse> getPerformBidirectionalStreamMethod() {
    io.grpc.MethodDescriptor<Bank.ConvertCurrencyRequest, Bank.ConvertCurrencyResponse> getPerformBidirectionalStreamMethod;
    if ((getPerformBidirectionalStreamMethod = BankServiceGrpc.getPerformBidirectionalStreamMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getPerformBidirectionalStreamMethod = BankServiceGrpc.getPerformBidirectionalStreamMethod) == null) {
          BankServiceGrpc.getPerformBidirectionalStreamMethod = getPerformBidirectionalStreamMethod = 
              io.grpc.MethodDescriptor.<Bank.ConvertCurrencyRequest, Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "performBidirectionalStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Bank.ConvertCurrencyResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new BankServiceMethodDescriptorSupplier("performBidirectionalStream"))
                  .build();
          }
        }
     }
     return getPerformBidirectionalStreamMethod;
  }
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getCurrencyStream(Bank.ConvertCurrencyRequest request,
                                  io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<Bank.ConvertCurrencyRequest> performBidirectionalStream(
        io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getPerformBidirectionalStreamMethod(), responseObserver);
    }
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            getPerformBidirectionalStreamMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                Bank.ConvertCurrencyRequest,
                Bank.ConvertCurrencyResponse>(
                  this, METHODID_PERFORM_BIDIRECTIONAL_STREAM)))
          .build();
    }
  }
  ...
  public static final class BankServiceStub extends io.grpc.stub.AbstractStub<BankServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<Bank.ConvertCurrencyRequest> performBidirectionalStream(
        io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
      return asyncBidiStreamingCall(
          getChannel().newCall(getPerformBidirectionalStreamMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<Bank.ConvertCurrencyResponse> getCurrencyStream(
  ...
  private static final int METHODID_PERFORM_BIDIRECTIONAL_STREAM = 3;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
      ...
      switch (methodId) {
        case METHODID_PERFORM_STREAM:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.performStream(
              (io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse>) responseObserver);
        case METHODID_PERFORM_BIDIRECTIONAL_STREAM:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.performBidirectionalStream(
              (io.grpc.stub.StreamObserver<Bank.ConvertCurrencyResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
      ...
      synchronized (BankServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getPerformBidirectionalStreamMethod())
              .build();
        }
      }
    }
